		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-inner">
					<h4>Estas seguro de quere eliminar el rol <strong class="text-red">{{ $roles->name }}</strong>, esta operacion no se puede revertir</h4>
				</div>
					<div class="modal-footer">
						<p class="text-right">
						
						<form action="{{ action('RolesController@destroy', $roles->id) }}" method="post">
							{!! csrf_field() !!}
